    ...
    $(document).on('ready', function () {
        ...
        $("#resume-btn").on('click', function () {
            if (!firstTime) {
                ...
                var element5 = document.getElementById('line-container5');
                var element6 = document.getElementById('line-container6');
                ...
                var circle1 = new ProgressBar.Circle(element1, {
                    ...
                    step: function (state, circle1) {
                        ...
                        // const circle11 = document.querySelector("#progress-text1").textContent;
                        // console.log(circle11);
                        // console.log(circle11);
                        // $("#progress-text1").text((circle11* 100).toFixed(0) + "%");
                ...
                var circle5 = new ProgressBar.Circle(element5, {
                    ...
                    step: function (state, circle5) {
                        circle5.path.setAttribute('stroke', state.color);
                        $("#progress-text5").text((circle5.value() * 100).toFixed(0) + "%");
                    }
                });
                var circle6 = new ProgressBar.Circle(element6, {
                    ...
                    step: function (state, circle6) {
                        circle6.path.setAttribute('stroke', state.color);
                        $("#progress-text6").text((circle6.value() * 100).toFixed(0) + "%");
                    }
                });
